...
const registedCommandList = ['./commands/demo', //  命令demo
// 解析日志
...
'./commands/watch_dog/alarm', './commands/create_cache/update_per_ten_minute', // 更新缓存
// 任务调度
'./commands/task/manage', //  任务调度
'./commands/task/saveLog', // 工具类命令
...
// 测试uc
'./commands/utils/testUC']; // register commands
