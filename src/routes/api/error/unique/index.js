...
import MErrorSummary from '~/src/model/summary/error_summary'; // import Viser from '~/src/routes/api/error/viser'
...
let getGeographyDistribution = RouterConfigBuilder.routerConfigBuilder('/api/error/distribution/geography', RouterConfigBuilder.METHOD_TYPE_GET, async (req, res) => {
  ...
  for (let rawRecord of rawRecordList) {
    let cityDistribution = _.get(rawRecord, ['city_distribution'], {}); // 按省份进行统计
...
export default { ...getErrorLogList,
  ...getUrlDistribution,
  ...getErrorNameList,
