...
class TimeOnSiteByHour extends ParseBase {
  ...
  async execute(args, options) {
    ...
    for (let rawProject of rawProjectList) {
      ...
      this.log('totalUv ', totalUv); // 录入数据

      let isSuccess = await MDurationDistribution.replaceUvRecord(projectId, totalStayMs, totalUv, countAtMoment.format(DATE_FORMAT.DATABASE_BY_UNIT[countType]), countType, cityDistribute);
...
//# sourceMappingURL=time_on_site.js.map